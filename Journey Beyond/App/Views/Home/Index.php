...
<body>
    <header>
        ...
        <ul class="navbar">
            ...
            <div class="links">
                <li><button class="SignIn" onclick="location.href='../Sign In/User.html'">Login</button></li>
                <li><button class="SignUp" onclick="location.href='../Sign Up/User.html'">Sign Up</button></li>
            </div>
        </ul>
    </header>
