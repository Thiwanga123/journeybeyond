...
<head>
    ...
    <link rel="stylesheet" href="../../../Public/CSS/My Inventory.css">
    <title>Home</title>
</head>
<body>
    <!-- SideBar -->
    ...
    <div id="addProductModal" class="modal-container">
        <div class="modal">
            ...
            <div class="modal-form">
                <form id="addProductForm" action="addProductController.php" method = "POST" enctype="multipart/form-data"> 
                    <div class="left">
                    ...
                    <div class="right">
                        ...
                        <div id="uploadImagesContainer" style="margin-top: 10px; cursor: pointer;">
                            ...
                            <input type="file" id="productImage"  accept="image/*"  name="productImage" multiple style="display: none;" required>
                        </div>
     ...
     <script src="../../../Public/JS Scripts/addProduct.js"></script>
